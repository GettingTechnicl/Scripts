...
(Get-BitLockerVolume -MountPoint C).KeyProtector.recoverypassword –match ‘\S’  > "\\Server2\mis\Computer Encryption\BitLocker Recovery Keys\New\$($env:computername -replace '\D','').TXT"
